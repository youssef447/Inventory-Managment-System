      ...
      rows: List.generate(
        ...
        (index) => DataRow(
          ...
          cells: [
            ...
            DataCell(
              Text(
                ...
                style: AppTextStyles.font16BlackRegularCairo.copyWith(
                  color: controller.requestsOfAssets[index].status.tr.getColor,
                ),
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
            ...
            DataCell(
              Text(
                controller.requestsOfAssets[index].assetsEntity!.assetName,
                style: AppTextStyles.font16BlackRegularCairo,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
            ...
            DataCell(
              Text(
                controller.requestsOfAssets[index].assetsEntity!.subcategory,
                style: AppTextStyles.font16BlackRegularCairo,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
