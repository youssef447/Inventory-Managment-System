      ...
      rows: List.generate(
        ...
        (index) => DataRow(
          color: WidgetStatePropertyAll(
            index % 2 == 0 ? AppColors.evenRowColor : AppColors.oddRowColor,
          ),
          cells: [
            DataCell(
              Text(
            ...
            DataCell(
              Text(
                DateTimeHelper.formatDate(
                  controller.requestsOfConsumables[index].expectedRecieved,
                ),
                style: AppTextStyles.font16BlackRegularCairo,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
            ...
            DataCell(
              Text(
                controller.requestsOfConsumables[index].consumablesEntity!.name,
                style: AppTextStyles.font16BlackRegularCairo,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
            ...
            DataCell(
              Text(
                controller
                    .requestsOfConsumables[index].consumablesEntity!.category,
                style: AppTextStyles.font16BlackRegularCairo,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
            ...
            DataCell(
              Text(
                controller
                    .requestsOfConsumables[index].consumablesEntity!.model,
                style: AppTextStyles.font16BlackRegularCairo,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
            ...
            DataCell(
              Text(
                controller
                    .requestsOfConsumables[index].consumablesEntity!.brand,
                style: AppTextStyles.font16BlackRegularCairo,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
