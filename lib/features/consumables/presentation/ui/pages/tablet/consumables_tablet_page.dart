...
class ConsumablesTabletPage extends StatelessWidget {
  const ConsumablesTabletPage({super.key, required this.readOnly});
                  ...
                  controller.consumablesList.length,
                    ...
                    cells: [
                      ...
                      DataCell(
                        Center(
                          child: Text(
                            controller.consumablesList[index].unitOfMeasurement,
                            style: AppTextStyles.font16BlackRegularCairo,
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                          ),
                      ...
                      DataCell(
                        Center(
                          child: Text(
                            controller.consumablesList[index].expirationDate != null
                                ? DateTimeHelper.formatDate(
                              controller.consumablesList[index].expirationDate!,
                            )
                                : 'Not Applicable',
                            style: controller.consumablesList[index].expirationDate != null
                                ? AppTextStyles.font16BlackRegularCairo
                        ...
                        Center(
                          child: Text(
                            ...
                            style: AppTextStyles.font16BlackRegularCairo.copyWith(
                                color:    controller.consumablesList[index].status.getColor
                            ),
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                          ),
