...
abstract class AppTextStyles {
  ...
  static TextStyle get font16SecondaryBlueCairoRegular => GoogleFonts.cairo(
    fontSize: 16.sp,
    color: AppColors.blue,
    fontWeight: AppFontWeights.regular,
  );
  ...
  static TextStyle get font16secondaryBlackRegularCairo => GoogleFonts.cairo(
        color: AppColors.secondaryBlack,
        fontSize: 16.sp,
        fontWeight: AppFontWeights.regular,
      );
  ...
  static TextStyle get font10SecondaryBlackCairoMedium => GoogleFonts.cairo(
        fontSize: 10.sp,
        color: AppColors.secondaryBlack,
        fontWeight: AppFontWeights.medium,
      );
  ...
  static TextStyle get font12darkWhiteShadowCairoMedium => GoogleFonts.cairo(
        fontSize: 12.sp,
        color: AppColors.darkWhiteShadow,
        fontWeight: AppFontWeights.medium,
      );
  ...
  static TextStyle get font13SecondaryBlackCairoMedium => GoogleFonts.cairo(
        fontSize: 13.sp,
        color: AppColors.secondaryBlack,
        fontWeight: AppFontWeights.medium,
      );
  ...
  static TextStyle get font14darkWhiteShadowCairoMedium => GoogleFonts.cairo(
        fontSize: 14.sp,
        color: AppColors.darkWhiteShadow,
        fontWeight: AppFontWeights.medium,
      );
