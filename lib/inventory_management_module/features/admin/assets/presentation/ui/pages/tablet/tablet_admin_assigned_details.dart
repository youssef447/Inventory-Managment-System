...
class TabletAdminAssignedDetails extends StatelessWidget {
  const TabletAdminAssignedDetails({
    super.key,
              ...
              children: [
                ...
                SizeAnimation(
                  child: OrientationHelper(
                      landScape: HorizontalAssignedDetailsCard(
                        assets: assignedUser.productentity.assetEntity!,
                      ),
                      portrait: VerticalAssignedDetailsCard(
                        assets: assignedUser.productentity.assetEntity!,
                      )),
                ),
                verticalSpace(12),
                GetBuilder<AdminAssetsController>(builder: (controller) {
                  return Row(
                    children: [
                      Text(
