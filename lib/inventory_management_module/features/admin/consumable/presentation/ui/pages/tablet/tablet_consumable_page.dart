              ...
              rows: List.generate(
                controller.consumables.length,
                  ...
                  cells: [
                    ...
                    DataCell(
                      Text(
                        controller.consumables[index].brand + controller.consumables[index].model,
                        style: AppTextStyles.font16BlackRegularCairo,
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                    ...
                    DataCell(
                      Text(
                        controller.consumables[index].quantityOnHand.toString(),
                        style: AppTextStyles.font16BlackRegularCairo,
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                    ...
                    DataCell(
                      Text(
                        controller.consumables[index].reorderLevel.toString(),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                    ),
                    DataCell(
                      Text(
                        controller.consumables[index].reorderQuantity.toString(),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                    ),
