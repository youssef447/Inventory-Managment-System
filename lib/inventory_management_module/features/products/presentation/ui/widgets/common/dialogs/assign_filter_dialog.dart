...
//Youssef Ashraf
///Represents the asset requests filter dialog in tablet and mobile views
class AssignFilterDialog extends GetView<ProductsController> {
  const AssignFilterDialog({super.key});
